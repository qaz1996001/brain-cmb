# ISO 14971 風險管理過程指南 (brain-cmb)

**文件 ID**: DOC-BRAIN-CMB-REG-011  
**標題**: brain-cmb 專案醫療器材風險管理流程指南  
**版本**: v1.0.0  
**狀態**: Active  
**建立日期**: 2025-12-24
...
本文件定義 `brain-cmb` 專案如何實作 ISO 14971:2019 標準要求，系統性地管理 AI 軟體在預期用途下的所有風險。
...
## 3. 風險管理報告
- 定期產出風險管理總結報告，存放於 `docs/brain-cmb/compliance/`。
