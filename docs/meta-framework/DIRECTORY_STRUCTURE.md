...
│       ├── compliance-mapping-template.md           # 🔜 合規性對照範本
│       ├── software-lifecycle-template.md           # 🔜 軟體生命週期文檔範本
│       ├── traceability-matrix-guide.md             # 🔜 追溯性管理指南
│       └── risk-management-bridge-template.md       # 🔜 風險管理橋接範本
│
...
🔜 regulations/ISO-20816/
   ├── compliance-mapping-template.md        # ISO 20816 合規性對照
   └── traceability-matrix-guide.md          # 追溯性管理指南
```
