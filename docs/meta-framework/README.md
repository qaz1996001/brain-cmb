...
> 一套通用的、標準化的文檔系統與開發流程，支援軟體、韌體、產品開發，內建醫療器材 (IEC 62304/ISO 14971) 與資訊安全 (ISO 27001) 標準合規性。
...
- ✅ **完整追溯性管理**（需求→設計→實作→測試→風險控制）
- ✅ **國際標準合規性支援**（IEC 62304, ISO 14971, ISO 27001 等）
- ✅ **人機協作模式**（明確的人類與 AI 在合規環境下的職責分工）
...
│   └── ISO-20816/                         # 機械振動監測與診斷標準
│       ├── compliance-mapping-template.md
│       ├── software-lifecycle-template.md
│       ├── traceability-matrix-guide.md
│       └── risk-management-bridge-template.md
│
...
# 1. 複製需求範本
cp docs/resource/meta-framework/requirements/TEMPLATE_SYSTEM_PRD_SR_SD.md \
   <medical-device>/docs/requirements/01_SYSTEM_PRD_SR_SD.md

# 2. 複製合規性範本 (如 IEC 62304)
cp docs/resource/meta-framework/regulations/IEC-62304/compliance-mapping-template.md \
   <medical-device>/docs/regulations/IEC-62304-compliance.md

# 3. 填寫軟體安全分類（Class A/B/C）
# 4. 建立完整追溯矩陣（需求→設計→實作→測試→風險控制）
# 5. 遵循 AI 協作指南中的醫療軟體規範進行開發
```
...
- ✅ Quality Management System（品質管理系統）
- ✅ Design and Development（設計與開發）
- ✅ Risk Management Integration（風險管理整合）

### IEC 62304:2006+AMD1:2015（醫療器材軟體生命週期）

- ✅ Software Safety Classification（軟體安全分類）
...
| [`regulations/ISO-20816/`](regulations/ISO-20816/) | 機械振動監測與診斷範本 |
...
| 版本 | 日期 | 變更摘要 |
|------|------|---------|
| v1.1.0 | 2025-12-24 | 整合醫療器材 (IEC 62304) 與資安標準，更新 AI 協作與 Code Review 指南 |
