...
3. **符合國際標準**：內建 ISO 13485, IEC 62304, ISO 14971, IEC 62366, ISO 27001, ISO/IEC 23894 等標準支援
4. **人機協作開發**：明確人類與 AI 在醫療軟體開發生命週期 (SDLC) 中的職責分工
...
| **ISO 13485:2016** | 醫療器材品質管理系統 | ✅ 品質管理系統範本、合規性對照表 |
| **IEC 62304:2006+AMD1:2015** | 醫療器材軟體生命週期 | ✅ 軟體生命週期範本、安全分類指南 |
| **ISO 14971:2019** | 醫療器材風險管理 | ✅ 風險管理流程指南、風險分析範本 |
| **IEC 62366-1:2015** | 醫療器材可用性工程 | ✅ 可用性工程流程指南 |
| **ISO/IEC 27001:2022** | 資訊安全管理系統 | ✅ 資訊安全管理指南 |
| **ISO/IEC 23894:2023** | AI 風險管理 | ✅ AI 風險管理指南 |

**使用方式**：
1. 根據專案性質選擇適用標準（如工業設備選 ISO 20816）
...
**步驟**：
1. 選擇適用標準：ISO 20816, ISO 13485, ISO 14971
2. 使用 `regulations/ISO-20816/` 範本建立合規性文檔
3. 撰寫軟體需求規格（SRS），明確標註安全分類（Class A/B/C）
4. 建立風險管理檔案（配合 ISO 14971）
5. 進行定期合規性審計（每季度）
6. 準備稽核包（需求→設計→實作→測試→風險管理的完整追溯）
...
- 🏥 [`regulations/ISO-20816/compliance-mapping-template.md`](regulations/ISO-20816/compliance-mapping-template.md) — 工業設備合規
