...
from pipelinecore.dicomseg.schema.enum import SeriesTypeEnum
from pipelinecore.dicomseg.schema.base import MaskRequest,MaskSeriesRequest, MaskInstanceRequest
from pipelinecore.dicomseg.schema.base import AITeamRequest, StudyRequest,SortedRequest,StudyModelRequest
